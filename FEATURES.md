...
- `reclaimer remote history list/diff/report` reads saved remote scan audit records, compares bucket/path growth, writes optional redacted Markdown, and never connects to or mutates a server.
