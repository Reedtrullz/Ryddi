...
| Keep local audit trail | Save plans, receipts, native reports, container reports, active-file reports, and Trash review reports under Application Support with local-only JSON. | `AuditStore`, app Audit History |
