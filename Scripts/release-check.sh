...
printf '{"packageManager":"npm@10.8.0","scripts":{"build":"vite build","clean":"rimraf dist .next","deploy":"vercel --prod --token=abc123","postinstall":"node scripts/postinstall.js","test:coverage":"vitest --coverage","bad script":"echo unsafe"}}\n' >"$project_web/package.json"
