...
- Report-only Project Dependencies Review for project-local dependency/build artifact folders, protected project roots, native rebuild guidance, and local audit history
