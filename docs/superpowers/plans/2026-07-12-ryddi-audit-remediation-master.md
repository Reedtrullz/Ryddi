...
Human QA remains separate from automated release proof. The Ryddi-only About panel and sidebar collapse/restore states were captured. A Finder capture containing unrelated filenames was removed from the public release, and a full-screen Dock capture containing unrelated desktop content was discarded locally. Subjective VoiceOver announcement quality, exact minimum-size sidebar interaction, and Finder/Dock/app-switcher icon appearance are not claimed as human-reviewed.
