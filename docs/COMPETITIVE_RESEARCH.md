...
4. Large-file and old-file review mode plus archive-candidate checklists now exist, and Trash Review now reports current Trash contents without emptying. Next depth is saved filters, evidence-detail transitions, and user-controlled archive/Trash workflows.
