...
2. Container rule pack: Docker/Colima inventory, volumes/images/build cache, native prune guidance, VM disk warnings. Preview receipts, read-only live inventory, and explicitly allowlisted native execution receipts exist; future work should add deeper confirmation UX for destructive Docker/Colima native prune flows.
